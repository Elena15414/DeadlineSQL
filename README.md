[![Build status](https://ci.appveyor.com/api/projects/status/a8clrs70oynatxe4/branch/main?svg=true)](https://ci.appveyor.com/project/Elena15414/deadlinesql/branch/main)
...
-Запустить SUT (app-deadline.jar). Для указания параметров подключения к базе данных можно использовать:
    ...
    Приложение не использует файл application.properties в качестве конфигурации, конфигурационный файл находится внутри JAR-архива;
